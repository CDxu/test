...
public class Packager {
    ...
    static UnityEngine.Object LoadAsset(string file) {
        ...
        return AssetDatabase.LoadMainAssetAtPath("Assets/mj/lua/" + file);
    }
    ...
    static void HandleExampleBundle() {
        ...
        AddBuildMap("test" + AppConst.ExtName, "*.bytes", "Assets/Resources/UI/test");
        AddBuildMap("test" + AppConst.ExtName, "*.png", "Assets/Resources/UI/test");
