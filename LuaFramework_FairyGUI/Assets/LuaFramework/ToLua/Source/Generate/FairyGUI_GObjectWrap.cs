...
public class FairyGUI_GObjectWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("sourceWidth", get_sourceWidth, null);
		L.RegVar("sourceHeight", get_sourceHeight, null);
		L.RegVar("initWidth", get_initWidth, null);
		L.RegVar("initHeight", get_initHeight, null);
